...
public class Transactiion_Sucessfull_Adapter extends RecyclerView.Adapter<Transactiion_Sucessfull_Adapter.MyViewHolder>  {
   ...
   SessionManager sessionManager;
    ...
    public Transactiion_Sucessfull_Adapter(Activity activity, List<Transaction_Bean> moviesList) {
