...
import com.renewin.Xohri.Fragment.AddModelFragment;
import com.renewin.Xohri.R;

import java.util.List;

public class AddHpAdapter extends RecyclerView.Adapter<AddHpAdapter.MyViewHolder>  {
   ...
   public static LinearLayout next_arw;
    ...
    public AddHpAdapter(Activity activity, List<FarmsImageBean> moviesList) {
