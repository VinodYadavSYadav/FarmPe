...
public class AdapterStatusViewed extends RecyclerView.Adapter<AdapterStatusViewed.MyViewHolder>  {
    ...
    public AdapterStatusViewed(Activity activity, List<StatusBean> moviesList) {
...
//        session=new SessionManager(activity);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.a_ns_status_viewd, parent, false);
